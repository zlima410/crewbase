...
[ADR-002](ADR-002-use-supabase-auth.md).
...
- **Mobile web fallback** — the React app is responsive and covers the core
  ...
  is justified. See [ADR-009](ADR-009-mobile-strategy.md).

## Data & Storage

- **PostgreSQL via Supabase**, accessed through EF Core migrations. See
  [ADR-001](ADR-001-use-postgresql.md).
...
[ADR-007](ADR-007-free-tier-hosting.md).
